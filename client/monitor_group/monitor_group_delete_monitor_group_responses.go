...
func (o *MonitorGroupDeleteMonitorGroupBadRequest) GetPayload() *models.APIMessageInfo {
	return o.Payload
}
...
func (o *MonitorGroupDeleteMonitorGroupNotFound) GetPayload() *models.APIMessageInfo {
	return o.Payload
}
