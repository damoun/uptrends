...
func (o *MonitorGroupStopAllMonitorAlertsInGroupBadRequest) GetPayload() *models.MessageList {
	return o.Payload
}
...
func (o *MonitorGroupStopAllMonitorAlertsInGroupNotFound) GetPayload() *models.MessageList {
	return o.Payload
}
