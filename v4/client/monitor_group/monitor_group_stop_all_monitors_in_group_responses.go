...
func (o *MonitorGroupStopAllMonitorsInGroupBadRequest) GetPayload() *models.MessageList {
	return o.Payload
}
...
func (o *MonitorGroupStopAllMonitorsInGroupNotFound) GetPayload() *models.MessageList {
	return o.Payload
}
