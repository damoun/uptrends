...
func (o *MonitorGroupUpdateMonitorGroupBadRequest) GetPayload() *models.MessageList {
	return o.Payload
}
...
func (o *MonitorGroupUpdateMonitorGroupNotFound) GetPayload() *models.MessageList {
	return o.Payload
}
