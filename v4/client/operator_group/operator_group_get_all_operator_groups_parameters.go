...
for the operator group get all operator groups operation typically these are written to a http.Request
*/
...
// WithTimeout adds the timeout to the operator group get all operator groups params
...
// SetTimeout adds the timeout to the operator group get all operator groups params
func (o *OperatorGroupGetAllOperatorGroupsParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the operator group get all operator groups params
func (o *OperatorGroupGetAllOperatorGroupsParams) WithContext(ctx context.Context) *OperatorGroupGetAllOperatorGroupsParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the operator group get all operator groups params
func (o *OperatorGroupGetAllOperatorGroupsParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the operator group get all operator groups params
...
// SetHTTPClient adds the HTTPClient to the operator group get all operator groups params
